          ...
          <div className={styles.teamMember} key={member.id}>
            ...
            <div className={styles.social}>
              <ul className={styles.socialItem}>
                <Link href={member.social.github} alt={member.name} rel='noopener noreferrer' target="_blank">
                  <li className={styles.social__github}>
                    <FaGithub />
                  </li>
                </Link>
                <Link href={member.social.twitter} alt={member.name} rel='noopener noreferrer' target="_blank" >
                  <li className={styles.social__twitter}>
                    <FaTwitter />
                  </li>
                </Link>
                <Link href={member.social.linkedin} alt={member.name} rel='noopener noreferrer' target="_blank">
                  <li className={styles.social__linkedin}>
                    <FaLinkedin />
                  </li>
                </Link>
                <Link href={member.social.instagram} alt={member.name} rel='noopener noreferrer' target="_blank">
                  <li className={styles.social__instagram}>
                    <FaInstagram />
                  </li>
                </Link>

                <Link href={`mailto:${member.email}`} alt={member.name} rel='noopener noreferrer' target="_blank">
