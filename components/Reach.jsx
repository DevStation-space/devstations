...
//         <Image src={community} alt="communitylogo"/>
//         <div>
  ...
  <div className={styles.Stats__head}>Our Reach</div>
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <div className={styles.title}>Community Members </div>
      </div>
      <div className={styles.card}>
        <div className={styles.cardIcon}>
          <svg
        ...
        <div className={styles.title}>Opportunities Created </div>
      </div>
      <div className={styles.card}>
        <div className={styles.cardIcon}>
          <svg
        ...
        <div className={styles.number}>2,000+</div>
        <div className={styles.title}>College Members </div>
      </div>
    </div>
  </div>
);
