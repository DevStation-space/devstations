...
import { faBriefcase, faCode, faUsers, faHandHoldingHeart, faChalkboardTeacher, faIndustry, faCodeBranch } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="bg-gray-800 text-white py-12">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center p-4 rounded-lg border">
          <FontAwesomeIcon icon={faHandHoldingHeart} className="text-4xl mb-4" />
          Mentorship
        </div>
        <div className="text-center p-4 rounded-lg border">
          <FontAwesomeIcon icon={faChalkboardTeacher} className="text-4xl mb-4" />
